...
public class CharPaintMain__drawing_board extends JFrame implements MouseMotionListener {
	...
	public CharPaintMain__drawing_board() {
	...
	public static void main(String[] args) {
		new CharPaintMain__drawing_board();
	}
