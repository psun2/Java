...
class setEnabled extends JFrame {

	public setEnabled(String title) {
		setTitle(title);
		init();
	}
...
//		add(menuBar); // add 가 아님
		...
		// 접근을 menu로 합니다.
		item2.setEnabled(false); // 활성화 를 false를 줌으로써, 비활성화 시킵니다.
		...
		menu2_1_item2.setEnabled(false);
...
public class setEnabled_메뉴비활성화 {

	public static void main(String[] args) {

		new setEnabled("메뉴비활성화");
