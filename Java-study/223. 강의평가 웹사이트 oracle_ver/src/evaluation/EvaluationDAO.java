...
//						+ startPage + " AND NO <= " + endPage;
			...
			while (rs.next()) {
				...
				evaluation.setLectureName(rs.getString(4));
				evaluation.setProfessorName(rs.getString(5));
				...
				evaluation.setEvaluationTitle(rs.getString(9));
				evaluation.setEvaluationContent(rs.getString(10));
