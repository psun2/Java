...
public class MePuyoPanelTemp extends JPanel {
	...
	public MePuyoPanelTemp(PuyoFrame frame) {
...
//                  frame.data.chk = true;
						...
						if (frame.enemyData.endGame && MePuyoPanelTemp.this.meInfo.endGame) {
							MePuyoPanelTemp.this.lobbyChk = true;
							ModalFrame mf = new ModalFrame(MePuyoPanelTemp.this.frame, "승리");
						} else { // 상대방이 게임이 안끝났으면 나는 패배
							ModalFrame mf = new ModalFrame(MePuyoPanelTemp.this.frame, "패배");
					...
					if (MePuyoPanelTemp.this.itemChk)
						addItem();
