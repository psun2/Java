...
//		writeOkCommand.excute(a);
	...
	public String view(Model model, @Validated BoardDTO dto, BindingResult result) {
...
//		String a = null;
		...
		String uid = result.getFieldErrors().get(0).getField();
		...
		// boardControllerUidValidator.validate(uid, result);
