...
public class JoinTest extends JFrame {
   ...
   public JoinTest() {
      ...
      lblNewLabel_4.setBounds(354, 404, 187, 21);
      ...
      JComboBox day = new JComboBox(); //ÀÏ
      ...
      month.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			  ...
			  System.out.println("ÇØ´ç³âµµ: "+calders.get(Calendar.YEAR));
			  System.out.println("ÇØ´ç¿ù: "+(calders.get(Calendar.MONTH)+1)); //º¸¿©ÁÙ¶§ +1·Î ÇÏ¿© »ç¶÷±âÁØÀ¸·Î ¼³Á¤
			  System.out.println("¸¶Áö¸· ÀÏ(ÇöÀç ³¯Â¥ ±âÁØ ÃÖ´ë¼ö): "+calders.getActualMaximum(Calendar.DAY_OF_MONTH));
         ...
         if (e.getSource() == btnMakeMember) {   //È¸¿ø °¡ÀÔ 
            ...
            while (true) { //while ¹®À» µ¹·Á¼­ À¯È¿¼º °Ë»ç ÁøÇà
               ...
               if(truechk) {
            	   ...
            	   JOptionPane.showMessageDialog(null, "¿ùÀÇ ÃÖ´ëÀÏ¼ö¸¦ ³Ñ¾ú½À´Ï´Ù. ¶Ç´Â Àß¸ø ÀÔ·ÂÇÏ¼Ì½À´Ï´Ù.");
            	   break;
               }
               i++;
