package theory.exam_JTabbedPane;
...
//		setIconImage(new ImageIcon("").getImage());
	...
	JPanel signUP() {
		...
		ImageIcon logoImg = new ImageIcon("../033. JavaSwing(Component, Container) - 회원가입창 과제/exam_img/naver.png");
		...
		ImageIcon join = new ImageIcon("../033. JavaSwing(Component, Container) - 회원가입창 과제/exam_img/가입하기Btn.png");
...
//		calculator.setJMenuBar(menuBar);
		...
		ImageIcon icon1 = new ImageIcon("../034. JavaSwing(Menu, Layout, Font, Color) - 계산기 과제/exam-icons/icon1.png");
		JButton button1 = new JButton(icon1);
		button1.setBackground(new Color(241, 243, 242));
		button1.setBorder(null);
		btns.add(button1);

		ImageIcon icon2 = new ImageIcon("../034. JavaSwing(Menu, Layout, Font, Color) - 계산기 과제/exam-icons/icon2.png");
