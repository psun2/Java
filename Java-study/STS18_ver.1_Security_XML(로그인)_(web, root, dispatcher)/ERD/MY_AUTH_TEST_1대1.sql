...
-- 예시데이터
INSERT ALL
INTO member (mid, memberId, memberPassword, realMemberPassword)
VALUES (uid_seq.nextval, 'tjddjs90', 'zzzz1', 'zzzz1')
INTO member (mid, memberId, memberPassword, realMemberPassword)
VALUES (uid_seq.nextval + 1, 'tjddjs901', 'zzz1z', 'zzzz1')
INTO member (mid, memberId, memberPassword, realMemberPassword)
VALUES (uid_seq.nextval + 2, 'tjddjs902', 'z1zzz', 'zzzz1')
SELECT * FROM DUAL;
